...
class WillumpHashJoinMultiColNode(WillumpGraphNode):
    """
    ...
    def __init__(self, input_node: WillumpGraphNode, input_name: str, left_input_type: WeldType, output_name: str, join_col_names: List[str],
        ...
        self.join_col_name = join_col_names
    ...
    def get_node_weld(self) -> str:
        ...
        weld_program = \
            ...
            let pre_output = (for(INPUT_NAME.$0,
                STRUCT_BUILDER,
                |bs, i: i64, x |
    ...
    def __repr__(self):
        return "Multi-col Hash-join node for input {0} output {1}\n" \
