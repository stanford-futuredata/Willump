...
def get_row_to_merge_composer_features(key):
    global num_queries
    num_queries += 1
    return composer_features.loc[key]


def get_row_to_merge_lyrs_features(key):
    global num_queries
    num_queries += 1
    return lyrs_features.loc[key]
